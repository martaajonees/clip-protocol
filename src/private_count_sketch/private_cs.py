...
class privateCS:
    def __init__(self,epsilon,k,m, dataset, domain):
        ...
        self.G = utils.generate_hash_function_G(self.k, p, a, b)
...
if __name__ == "__main__":
    ...
    PCS = privateCS(args.e, args.k, args.m, dataset, domain)

    # Client side: process the private data
    privatized_data = PCS.execute_client()
    ...
    f_estimated = PCS.execute_server(privatized_data)
